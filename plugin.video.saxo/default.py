...
addonID = 'plugin.video.saxo'
addon = Addon(addonID, sys.argv)
local = xbmcaddon.Addon(id=addonID)
icon = local.getAddonInfo('icon')

YOUTUBE_CHANNEL_ID_1 = "UC92-DgDvLQPM_r2oHbDr60w"
YOUTUBE_CHANNEL_ID_2 = "UCT3tUboWKRJItMQWic7eCjg"
YOUTUBE_CHANNEL_ID_3 = "UC92-DgDvLQPM_r2oHbDr60w"
YOUTUBE_CHANNEL_ID_4 = "UC92-DgDvLQPM_r2oHbDr60w"
YOUTUBE_CHANNEL_ID_5 = "UC92-DgDvLQPM_r2oHbDr60w"
YOUTUBE_CHANNEL_ID_6 = "UC92-DgDvLQPM_r2oHbDr60w"
YOUTUBE_CHANNEL_ID_7 = "UC92-DgDvLQPM_r2oHbDr60w"
...
def main_list(params):
    ...
    plugintools.add_item( 
        #action="", 
        title="                                           [COLOR skyblue]CANAL EXOPLANETAS[/COLOR]",
    ...
    plugintools.add_item( 
        #action="", 
        title="                                  [COLOR skyblue]CANAL DOCUMENTALIA[/COLOR]",
